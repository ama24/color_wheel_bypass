...
#define PIN_LDUP          8    // SK01 pin 10 — MB OUTPUT (confirmed v1.3): MB generates ~42 kHz PWM
                               //               regardless of control PCB. Do NOT drive from ESP32.
...
// ---------------------------------------------------------------------------
// LDUP — NOT generated by ESP32 (v1.3 direction correction)
// The main board generates ~42 kHz PWM on this line regardless of the control
// PCB. Previously treated as a PCB output; confirmed MB output in v1.3.
// Constants below are retained for reference only — ldup_start/stop are
// never called.
// ---------------------------------------------------------------------------
#define LDUP_P0_H   1180ULL    // (unused — reference only)
#define LDUP_P1_L   1108ULL
#define LDUP_P2_H    236ULL
#define LDUP_P3_L   3959ULL
#define LDUP_P4_H    236ULL
#define LDUP_P5_L   2710ULL
#define LDUP_P6_H    236ULL
#define LDUP_P7_L   1107ULL
