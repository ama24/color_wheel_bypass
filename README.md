...
> **Direction convention — all connectors:** Direction is expressed from the **main board's perspective**.
> **MB OUTPUT** = signal originates from the main board. **MB INPUT** = signal is received by the main board.
> **BIDIR** = bidirectional. **PWR** = power rail.
...
|-----|--------|---------|-----------|----------|
| 1 | LUM | 3V DC | MB INPUT | Brightness reference from control PCB |
| 2 | RXDBG | 5V DC | MB OUTPUT | Debug UART TX from main board to control PCB |
| 3 | TXDBG | 3.3V DC | MB INPUT | Debug UART RX from control PCB — mirrors first RX0LD packet |
| 4 | LDPCN | 3.3V digital | MB OUTPUT | Light driver enable — asserted by main board ~3 s after power-on |
| 5 | CIDX | 3.3V pulsed | MB OUTPUT | Colour/frame sync from main board to DMD |
| 6 | RX0LD | 3.3V UART | MB INPUT | UART from control PCB to main board (19200 baud 8N1) |
| 7 | TX0LD | 3.3V UART | MB OUTPUT | UART from main board to control PCB (19200 baud 8N1) |
| 8 | LENBL | 3.3V digital | MB OUTPUT | Light enable from main board |
...
| 10 | LDUP | 3.3V PWM | MB OUTPUT | ~42 kHz PWM generated by the main board regardless of the control PCB. Previously misidentified as a PCB output — corrected in v1.3. |
| 11 | V5P0LD | 5V DC | PWR | 5V power rail supplied to control PCB from main board |
| 12 | GND | 0V | PWR | Ground |
| 13 | PRSV | 5V DC | MB INPUT | Presence detect — must be HIGH for main board to initialise |
...
| Pin | Signal | Voltage | Direction | Function |
|-----|--------|---------|-----------|----------|
| 1 | C-C | 12V pulsed | MB OUTPUT | BLDC motor phase C |
| 2 | C-A | 12V pulsed | MB OUTPUT | BLDC motor phase A |
| 3 | C-B | 12V pulsed | MB OUTPUT | BLDC motor phase B |
| 4 | CGND | 0V | PWR | Motor ground |
| 5 | SENS | 3.3V pulsed | MB INPUT | Rotation index — 1 pulse/rev (~120–170 Hz); used to sync with CIDX |
| 6 | C3V3P | 3.3V | PWR | Logic supply for Hall effect sensors |
| 7 | CMD | ~10V pulsed | MB OUTPUT | Motor speed control signal |
...
| Pin | Signal | Voltage | Direction | Function |
|-----|--------|---------|-----------|----------|
| 1 | VREF | 2.54V DC | MB OUTPUT | Reference voltage for DAC circuits |
| 2 | GND | 0V | PWR | Ground |
| 3 | CTRL A | 0–3V stepped | MB OUTPUT | Red laser brightness/mode control channel A |
| 4 | CTRL B | 0–3V stepped | MB OUTPUT | Red laser brightness/mode control channel B |
| 5 | CTRL C | 0–3V stepped | MB OUTPUT | Red laser brightness/mode control channel C |
...
| Pin | Signal | Voltage | Direction | Function |
|-----|--------|---------|-----------|----------|
| 1 | PHSENSE | 2.85V analogue | MB INPUT | Photo sense — 2.85V steady when light source active. Pulses 2.85V↔0V at ~125 Hz when laser output physically blocked (photodiode monitoring light throughput). |
| 2 | TX | 3.3V UART | MB OUTPUT | UART TX from main board to thermal MCU |
| 3 | RX | 3.3V UART | MB INPUT | UART RX from thermal MCU to main board |
| 4 | FPCN4 | 3.3V digital | MB OUTPUT | Fan enable channel 4 — 0V=off, 3.3V=on |
| 5 | FPCN2 | 3.3V digital | MB OUTPUT | Fan enable channel 2 — 0V=off, 3.3V=on |
| 6 | I2SCL | 3.3V digital | MB OUTPUT | I2C clock — main board is master |
...
| 12 | — | — | — | Not populated |
| 13 | FPCN5 | 3.3V digital | MB OUTPUT | Fan enable channel 5 — 0V=off, 3.3V=on |
| 14 | FPCN3 | 3.3V digital | MB OUTPUT | Fan enable channel 3 — 0V=off, 3.3V=on |
| 15 | FPCN1 | 3.3V digital | MB OUTPUT | Fan enable channel 1 — 0V=off, 3.3V=on |
| 16 | — | — | — | Not populated |
| 17 | — | — | — | Not populated |
| 18 | FG2 | 3.3V digital | MB INPUT | Fan tachometer 2 — main board does not read this |
| 19 | FG1 | 3.3V digital | MB INPUT | Fan tachometer 1 — main board does not read this |
